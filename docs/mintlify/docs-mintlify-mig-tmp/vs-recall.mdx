...
description: "Compare screenpipe and Microsoft Recall: an open-source Windows Recall alternative that runs on Mac, Windows, and Linux with no cloud dependency."
icon: "scale-balanced"
---
