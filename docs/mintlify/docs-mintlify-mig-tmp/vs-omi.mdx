...
sidebarTitle: "vs omi"
description: "Compare screenpipe to Omi (formerly Friend). Desktop screen + audio capture vs $89 AI wearable pendant. Both are open source — different approaches to AI memory."
icon: "scale-balanced"
---
