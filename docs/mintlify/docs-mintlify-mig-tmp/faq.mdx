...
<Expandable title="can I use screenpipe for free?">
  ...
  most users start with the CLI and upgrade to the paid app later for the visual timeline and features. the codebase is shared across all three, so open-source security audits apply to all versions.
</Expandable>
