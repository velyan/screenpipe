...
description: "Strip names, emails, phone numbers, addresses, account numbers, and secrets from screenpipe data before AI sees it, using local redaction or a confidential-compute enclave."
icon: "shield-halved"
---
