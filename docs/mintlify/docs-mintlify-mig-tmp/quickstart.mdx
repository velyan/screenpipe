...
go to **settings → connections** (under Data & Privacy). screenpipe supports dozens of integrations including Slack, Notion, Gmail, Google Calendar, Obsidian, Toggl, HubSpot, Salesforce, PostHog, Sentry, Zoom, and more. [learn more →](/connections)
